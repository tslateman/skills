...
| "Is this well-tested?"                   | `/testing`                       | `/test-review`, `/review`                  |
...
| "Is this well-written?"                  | `/prose`                         | `/slop-check`, `/review`                   |
...
| "Do I understand what I just committed?" | `/narrate`                       | `/review`                                  |
...
| "Show me what changed"                   | `/visual-recap`                  | `/review`                                  |
...
- `/narrate` + `/review` — Narrate gates comprehension before the commit; review catches what comprehension missed
